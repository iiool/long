...
if (!function_exists('easy_share_new_optins_texts')) :
    ...
    {
        global $pagenow;
        if (get_option('clickt3') || $pagenow == 'plugins.php' || (!get_option('easys2') && in_array('easy-share-solution/easy-share-solution.php', apply_filters('active_plugins', get_option('active_plugins'))))) {
            return;
        }
