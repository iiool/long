...
EOD;
    ...
    function setup_meta_boxes ( $post ) {
        ...
        add_meta_box( 'codedrops_meta_box', 'CodeTab',
                array(
                        $this,
...
EOD;
    ...
    function render_codedrops_meta_box () {
        $text1 = __(
                'Discover how this plugin is developed ! Learn WordPress Plugins Development with our free tutorial.',
                'sos-domain' );
        $text2 = __( 'WP Plugin Development Guide', 'sos-domain' );
        $html = <<<EOD
		<p>&nbsp;</p>
		<p>$text1</p>
		<p><h3><a href="https://www.codetab.org/tutorial/wordpress-plugin-development/" target="_blank">$text2</a></h3></p>
EOD;
        echo $html;
    }
    ...
    public function create_basic_locker () {
        ...
        if ( $post_id != 0 ) {
            ...
            add_post_meta( $post_id, 'shareon_twitter', '0' );
